...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum': [{'name': 'Node', 'type': 'str', 'value': 'Node', 'srcline': 44, 'srcfile': '/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Normal node', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'NodeWithoutSmooth', 'type': 'str', 'value': 'NodeWithoutSmooth', 'srcline': 45, 'srcfile': '/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'No smooth cost', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'SpeedNode', 'type': 'str', 'value': 'SpeedNode', 'srcline': 46, 'srcfile': '/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Search with speed', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Change search mode'}", &GlobalPlannerNodeConfig::default_node_type_)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum': [{'name': 'Node', 'type': 'str', 'value': 'Node', 'srcline': 44, 'srcfile': '/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Normal node', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'NodeWithoutSmooth', 'type': 'str', 'value': 'NodeWithoutSmooth', 'srcline': 45, 'srcfile': '/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'No smooth cost', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'SpeedNode', 'type': 'str', 'value': 'SpeedNode', 'srcline': 46, 'srcfile': '/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Search with speed', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Change search mode'}", &GlobalPlannerNodeConfig::default_node_type_)));
...
//#line 44 "/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_Node = "Node";
//#line 45 "/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_NodeWithoutSmooth = "NodeWithoutSmooth";
//#line 46 "/home/dev/mocapfly_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
